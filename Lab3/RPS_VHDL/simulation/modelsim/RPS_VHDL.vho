...
-- Equation(s):
-- \Mux0~0_combout\ = ( !\P1~input_o\ & ( \P2~input_o\ & ( (!\R1~input_o\ & (!\R2~input_o\ & (!\S2~input_o\ & \S1~input_o\))) ) ) ) # ( \P1~input_o\ & ( !\P2~input_o\ & ( (!\R1~input_o\ & (\R2~input_o\ & (!\S2~input_o\ & !\S1~input_o\))) ) ) ) # ( 
-- !\P1~input_o\ & ( !\P2~input_o\ & ( (\R1~input_o\ & (!\R2~input_o\ & (\S2~input_o\ & !\S1~input_o\))) ) ) )
...
PORT MAP (
	...
	datab => \ALT_INV_R2~input_o\,
	datac => \ALT_INV_S2~input_o\,
	datad => \ALT_INV_S1~input_o\,
	datae => \ALT_INV_P1~input_o\,
	dataf => \ALT_INV_P2~input_o\,
	combout => \Mux0~0_combout\);

-- Location: LABCELL_X88_Y21_N6
\W2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \W2~0_combout\ = ( !\P1~input_o\ & ( \P2~input_o\ & ( (\R1~input_o\ & (!\R2~input_o\ & (!\S2~input_o\ & !\S1~input_o\))) ) ) ) # ( \P1~input_o\ & ( !\P2~input_o\ & ( (!\R1~input_o\ & (!\R2~input_o\ & (\S2~input_o\ & !\S1~input_o\))) ) ) ) # ( 
-- !\P1~input_o\ & ( !\P2~input_o\ & ( (!\R1~input_o\ & (\R2~input_o\ & (!\S2~input_o\ & \S1~input_o\))) ) ) )
...
-- Equation(s):
-- \E1~0_combout\ = ( \R1~input_o\ & ( (\S1~input_o\) # (\P1~input_o\) ) ) # ( !\R1~input_o\ & ( (\P1~input_o\ & \S1~input_o\) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_P1~input_o\,
	datac => \ALT_INV_S1~input_o\,
	dataf => \ALT_INV_R1~input_o\,
